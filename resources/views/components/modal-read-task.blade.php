@foreach ($tasks as $task)
    <!-- Main modal -->
    <div id="read-task-{{ $task->id }}" tabindex="-1" aria-hidden="true"
            ...
            <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                ...
                <div class="flex justify-between mb-4 rounded-t sm:mb-5">
                    <div class="text-gray-900 md:text-xl dark:text-white">
                        ...
                        <p class="text-base font-semibold">
                            {{ $task->formattedDueTime }} {{ $task->formattedDueDate }}
                        </p>
                    </div>
                    <div>
                        <button type="button"
                            class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 inline-flex dark:hover:bg-gray-600 dark:hover:text-white"
                            data-modal-toggle="read-task-{{ $task->id }}">
                ...
                <div class="flex justify-between items-center">
                    <div class="flex items-center space-x-3 sm:space-x-4">
                        <button type="button" data-modal-target="edit-task-{{ $task->id }}"
                        ...
                        <button type="button" data-modal-target="delete-task-{{ $task->id }}" data-modal-toggle="delete-task-{{ $task->id }}"
                        ...
                        @include('components.modal-confirmation-task-delete')
                    </div>
                    @if ($task->status == 1)
