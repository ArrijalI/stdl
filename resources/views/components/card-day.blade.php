<div class="max-w-2xl mt-4 mx-auto text-center">
    <h2 class="text-4xl font-extrabold leading-tight tracking-tight text-gray-900 dark:text-white">
        <span class="text-transparent bg-clip-text bg-gradient-to-r to-blue-500 from-blue-900 dark:to-purple-300 dark:from-indigo-500">{{ $todayDayName }}</span>
    </h2>    
    <div class="mt-2">
        <div class="inline-flex items-center text-lg font-medium text-primary-600 dark:text-purple-300">
            {{ $todayDate }}
        </div>
    </div>
</div>
