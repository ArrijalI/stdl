<div
    ...
    <ul class="flex flex-wrap -mb-px">
        ...
        <li class="me-2">
            <a href="/tasks-week"
                class="inline-block p-4 select-none border-b-2 border-transparent rounded-t-lg hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300">Minggu
                Ini</a>
        </li>
        <li class="me-2">
            <a href="/tasks-month"
...
<div class="rounded-l mt-4 bg-gray-50 dark:bg-gray-800">
    @if($tasks->isEmpty())
        <p class="text-center select-none rounded-lg text-gray-500 dark:text-gray-400 py-4">Tidak Ada Tugas Hari Ini</p>
    @else
